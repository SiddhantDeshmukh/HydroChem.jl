...
# function twod2oned(g::Grid, axis='x')
#   if axis == 'x'
...
#     ylim=[(0.0, 1.1) (-0.0, 1.2) (-0.2, 1) (1.6, 3.0)],
...
function plot_curve(g::Grid; dim=1, fn="t.png", is_save=true)
  # dim: 1 = x1, 2 = x2
  # Take the middle index of the other dimension to make sure ghost cells are
  # excluded
  # g1 = twod2oned(g)
...
function plot_standard_sod_y(g::Grid; fn="t.png", is_save=true)
  g1 = twod2oned(g, 'y')
  return plot_standard_sod(g1; fn=fn, is_save=is_save)
end
...
# function plot_heat(g::Grid; fn="heat.png", is_save=true, zmin=0., zmax=2.)
function plot_heat(g::Grid; fn="heat.png", is_save=true, zmin=0.9, zmax=2.1)
  # calculate rho, u, p e
  x = g.x[g.xjlo:g.xjhi]
  y = g.y[g.yjlo:g.yjhi]
...
function plot_heat_four_panels(g::Grid; fn="heat.png", is_save=true, zmin=0.0, zmax=2.0)
  # calculate rho, u, p e
  x = g.x[g.xjlo:g.xjhi]
  y = g.y[g.yjlo:g.yjhi]
